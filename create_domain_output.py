...
if __name__ == "__main__":
  ...
  if args.filter_domains:
    ...
    create_domsbyprot(args.fasta_infile, args.pfam_path+'hmms-v'+args.pfam_version+'/', args.pfam_version,
                      args.results_path, concatenated_results_file, filtered_results_file)
